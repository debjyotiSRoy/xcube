  ...
  'syms': { 'xcube.basics': {},
            ...
            'xcube.l2r.models.core': { 'xcube.l2r.models.core.L2R_DotProductBias': ( 'l2r.models.core.html#l2r_dotproductbias',
                                       ...
                                       'xcube.l2r.models.core.L2R_NN.forward': ( 'l2r.models.core.html#l2r_nn.forward',
                                                                                 'xcube/l2r/models/core.py')},
            'xcube.layers': { 'xcube.layers.Diff_Planted_Attention': ('layers.html#diff_planted_attention', 'xcube/layers.py'),
            ...
            'xcube.text.callbacks': { 'xcube.text.callbacks.LabelForcing': ('text.callbacks.html#labelforcing', 'xcube/text/callbacks.py'),
                                      ...
                                      'xcube.text.callbacks.LabelForcing.after_pred': ( 'text.callbacks.html#labelforcing.after_pred',
                                                                                        'xcube/text/callbacks.py'),
                                      'xcube.text.callbacks.RunningCallback': ( 'text.callbacks.html#runningcallback',
                                                                                'xcube/text/callbacks.py'),
                                      'xcube.text.callbacks.RunningCallback.__init__': ( 'text.callbacks.html#runningcallback.__init__',
                                                                                         'xcube/text/callbacks.py'),
                                      'xcube.text.callbacks.RunningCallback.after_batch': ( 'text.callbacks.html#runningcallback.after_batch',
                                                                                            'xcube/text/callbacks.py'),
                                      'xcube.text.callbacks.RunningCallback.after_train': ( 'text.callbacks.html#runningcallback.after_train',
                                                                                            'xcube/text/callbacks.py'),
                                      'xcube.text.callbacks.RunningCallback.before_train': ( 'text.callbacks.html#runningcallback.before_train',
                                                                                             'xcube/text/callbacks.py'),
