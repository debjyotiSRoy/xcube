  ...
  'syms': { 'xcube.basics': {},
            ...
            'xcube.l2r.data.boot': { 'xcube.l2r.data.boot.BatchLbsChunkify': ( 'l2r.data.boot.html#batchlbschunkify',
                                     ...
                                     'xcube.l2r.data.boot.BatchLbsChunkify.encodes': ( 'l2r.data.boot.html#batchlbschunkify.encodes',
                                                                                       'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.lbs_chunked': ('l2r.data.boot.html#lbs_chunked', 'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.onehot_dsets': ('l2r.data.boot.html#onehot_dsets', 'xcube/l2r/data/boot.py')},
