...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'xcube.basics': {},
            ...
            'xcube.layers': { 'xcube.layers.ElemWiseLin': ('layers.html#elemwiselin', 'xcube/layers.py'),
                              ...
                              'xcube.layers.Lookup_Attention': ('layers.html#lookup_attention', 'xcube/layers.py'),
                              ...
                              'xcube.layers.topkmax': ('layers.html#topkmax', 'xcube/layers.py')},
            ...
            'xcube.text.all': {},
            'xcube.text.callbacks': { 'xcube.text.callbacks.LabelForcing': ('text.callabacks.html#labelforcing', 'xcube/text/callbacks.py'),
                                      'xcube.text.callbacks.LabelForcing.__init__': ( 'text.callabacks.html#labelforcing.__init__',
                                                                                      'xcube/text/callbacks.py'),
                                      'xcube.text.callbacks.LabelForcing.after_pred': ( 'text.callabacks.html#labelforcing.after_pred',
                                                                                        'xcube/text/callbacks.py')},
