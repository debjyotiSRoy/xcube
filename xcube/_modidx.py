  ...
  'syms': { 'xcube.basics': {},
            ...
            'xcube.l2r.callbacks': { 'xcube.l2r.callbacks.Monitor': ('l2r.callbacks.html#monitor', 'xcube/l2r/callbacks.py'),
                                     ...
                                     'xcube.l2r.callbacks.TrainEval.before_validate': ( 'l2r.callbacks.html#traineval.before_validate',
                                                                                        'xcube/l2r/callbacks.py')},
            'xcube.l2r.data.all': {},
            'xcube.l2r.data.boot': { 'xcube.l2r.data.boot.BatchLbsChunkify': ( 'l2r.data.info_gain.html#batchlbschunkify',
                                                                               'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.BatchLbsChunkify.__init__': ( 'l2r.data.info_gain.html#batchlbschunkify.__init__',
                                                                                        'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.BatchLbsChunkify.encodes': ( 'l2r.data.info_gain.html#batchlbschunkify.encodes',
                                                                                       'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.MutualInfoGain': ( 'l2r.data.info_gain.html#mutualinfogain',
                                                                             'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.MutualInfoGain.__init__': ( 'l2r.data.info_gain.html#mutualinfogain.__init__',
                                                                                      'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.MutualInfoGain._mutual_info_gain': ( 'l2r.data.info_gain.html#mutualinfogain._mutual_info_gain',
                                                                                               'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.MutualInfoGain.compute': ( 'l2r.data.info_gain.html#mutualinfogain.compute',
                                                                                     'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.MutualInfoGain.joint_pmf': ( 'l2r.data.info_gain.html#mutualinfogain.joint_pmf',
                                                                                       'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.MutualInfoGain.lbs_chunked': ( 'l2r.data.info_gain.html#mutualinfogain.lbs_chunked',
                                                                                         'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.MutualInfoGain.onehotify': ( 'l2r.data.info_gain.html#mutualinfogain.onehotify',
                                                                                       'xcube/l2r/data/boot.py')},
