...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'xcube.basics': {},
            ...
            'xcube.imports': {},
            'xcube.l2r.all': {},
            'xcube.l2r.callbacks': { 'xcube.l2r.callbacks.AvgSmoothMetric': ( 'l2r.callbacks.html#avgsmoothmetric',
            ...
            'xcube.l2r.models.core': { 'xcube.l2r.models.core.L2R_DotProductBias': ( 'l2r.models.core.html#l2r_dotproductbias',
                                       ...
                                       'xcube.l2r.models.core.L2R_NN.forward': ( 'l2r.models.core.html#l2r_nn.forward',
                                                                                 'xcube/l2r/models/core.py')},
            'xcube.layers': { 'xcube.layers.ElemWiseLin': ('layers.html#elemwiselin', 'xcube/layers.py'),
                              ...
                              'xcube.layers.Ranked_Attention': ('layers.html#ranked_attention', 'xcube/layers.py'),
                              ...
                              'xcube.layers.XMLAttention_old': ('layers.html#xmlattention_old', 'xcube/layers.py'),
                              'xcube.layers.XMLAttention_old.__init__': ('layers.html#xmlattention_old.__init__', 'xcube/layers.py'),
                              'xcube.layers.XMLAttention_old.forward': ('layers.html#xmlattention_old.forward', 'xcube/layers.py'),
            ...
            'xcube.text.models.core': { 'xcube.text.models.core.AttentiveSentenceEncoder': ( 'text.models.core.html#attentivesentenceencoder',
                                        ...
                                        'xcube.text.models.core.AttentiveSentenceEncoder.reset': ( 'text.models.core.html#attentivesentenceencoder.reset',
                                                                                                   'xcube/text/models/core.py'),
                                        'xcube.text.models.core.AttentiveSentenceEncoder2': ( 'text.models.core.html#attentivesentenceencoder2',
                                                                                              'xcube/text/models/core.py'),
                                        'xcube.text.models.core.AttentiveSentenceEncoder2.__init__': ( 'text.models.core.html#attentivesentenceencoder2.__init__',
                                                                                                       'xcube/text/models/core.py'),
                                        'xcube.text.models.core.AttentiveSentenceEncoder2.forward': ( 'text.models.core.html#attentivesentenceencoder2.forward',
                                                                                                      'xcube/text/models/core.py'),
                                        'xcube.text.models.core.AttentiveSentenceEncoder2.reset': ( 'text.models.core.html#attentivesentenceencoder2.reset',
                                                                                                    'xcube/text/models/core.py'),
