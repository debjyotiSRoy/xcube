  ...
  'syms': { 'xcube.basics': {},
            ...
            'xcube.text.models.core': { 'xcube.text.models.core.AttentiveSentenceEncoder': ( 'text.models.core.html#attentivesentenceencoder',
                                        ...
                                        'xcube.text.models.core.SequentialRNN.reset': ( 'text.models.core.html#sequentialrnn.reset',
                                                                                        'xcube/text/models/core.py'),
                                        'xcube.text.models.core.XMLPoolingLinearClassifier': ( 'text.models.core.html#xmlpoolinglinearclassifier',
                                                                                               'xcube/text/models/core.py'),
                                        'xcube.text.models.core.XMLPoolingLinearClassifier.__init__': ( 'text.models.core.html#xmlpoolinglinearclassifier.__init__',
                                                                                                        'xcube/text/models/core.py'),
                                        'xcube.text.models.core.XMLPoolingLinearClassifier.forward': ( 'text.models.core.html#xmlpoolinglinearclassifier.forward',
                                                                                                       'xcube/text/models/core.py'),
