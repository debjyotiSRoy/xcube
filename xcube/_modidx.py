  ...
  'syms': { 'xcube.basics': {},
            ...
            'xcube.l2r.callbacks': { 'xcube.l2r.callbacks.Monitor': ('l2r.callbacks.html#monitor', 'xcube/l2r/callbacks.py'),
                                     ...
                                     'xcube.l2r.callbacks.TrainEval.before_validate': ( 'l2r.callbacks.html#traineval.before_validate',
                                                                                        'xcube/l2r/callbacks.py')},
            'xcube.l2r.data.all': {},
            'xcube.l2r.data.boot': { 'xcube.l2r.data.boot.BatchLbsChunkify': ( 'l2r.data.boot.html#batchlbschunkify',
                                                                               'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.BatchLbsChunkify.__init__': ( 'l2r.data.boot.html#batchlbschunkify.__init__',
                                                                                        'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.BatchLbsChunkify.encodes': ( 'l2r.data.boot.html#batchlbschunkify.encodes',
                                                                                       'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.Booting': ('l2r.data.boot.html#booting', 'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.Booting.__init__': ( 'l2r.data.boot.html#booting.__init__',
                                                                               'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.Booting.joint_pmf': ( 'l2r.data.boot.html#booting.joint_pmf',
                                                                                'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.Booting.lbs_chunked': ( 'l2r.data.boot.html#booting.lbs_chunked',
                                                                                  'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.Booting.mutual_info_gain': ( 'l2r.data.boot.html#booting.mutual_info_gain',
                                                                                       'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot.Booting.onehotify': ( 'l2r.data.boot.html#booting.onehotify',
                                                                                'xcube/l2r/data/boot.py'),
                                     'xcube.l2r.data.boot._compute': ('l2r.data.boot.html#_compute', 'xcube/l2r/data/boot.py')},
