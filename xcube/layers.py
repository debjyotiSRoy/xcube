...
# %% auto 0
__all__ = ['ElemWiseLin', 'LinBnFlatDrop', 'LinBnDrop', 'Embedding', 'Linear_Attention', 'Ranked_Attention', 'lincomb',
           'soft_topkmax', 'XMLAttention']
...
class XMLAttention(Module):
    ...
    def forward(self, sentc):
        ...
        attn_wgts = soft_topkmax(self.LinAttn(sentc), dim=1) # lbl specific wts for each token (bs, max_len, n_lbs)
